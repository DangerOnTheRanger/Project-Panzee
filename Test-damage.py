...
# To fix this I have this run this program outside, which being next two both 'test' and 'panzee' Python will find that 'panzee' is a module, and then I have to run 'test_damage.py', with the same 'settings/path/privliges' for a lack of a better word
import time
import sys
try:
